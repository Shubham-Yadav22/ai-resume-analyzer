...
const Upload = () => {
  ...
  const handleAnalyze = async ({
    ...
    interface FeedbackMessageContent {
    ...
    const feedbackTyped: Feedback = feedback;
    const feedbackText: string =
      typeof feedbackTyped.message.content === 'string'
      ? feedbackTyped.message.content
      : feedbackTyped.message.content[0].text;
